...
jcv_point harmonic_force(const jcv_point r, const jcv_real size, const jcv_real k);
jcv_point get_force_ji(const jcv_site* si, const jcv_graphedge* edgei, const parameter* param);
